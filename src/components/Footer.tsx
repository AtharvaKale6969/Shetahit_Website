      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex space-x-4 pt-2">
            <a href="https://www.facebook.com/profile.php?id=61553188672484&mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" className="text-[#333333] hover:text-[#df6c1f] transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z"/></svg>
            </a>
            <a href="https://www.instagram.com/shetahit?igsh=czRmNmRqcjhkb2c3" target="_blank" rel="noopener noreferrer" className="text-[#333333] hover:text-[#df6c1f] transition-colors">
            ...
            <a href="https://www.linkedin.com/company/shetahit-farm-solutions/" target="_blank" rel="noopener noreferrer" className="text-[#333333] hover:text-[#df6c1f] transition-colors">
